...
if __name__ == '__main__':
    ...
    args.add_argument("-L", "--lorentz", type=int, default=0)
    ...
    STsim.ST_train(load_model=load_model_name, load_optimizer=load_optimizer_name,lorentz=args.lorentz, ratio=ratio)
