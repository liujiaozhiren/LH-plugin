...
class Attention(nn.Module):
    ...
    def grid_update_atten(self, output, context):
        ...
        self.linear_weight = autograd.Variable(self.linear_out.weight.data, requires_grad=False).cpu()
        self.linear_bias = autograd.Variable(self.linear_out.bias.data, requires_grad=False).cpu()
